...
pub const SERVERS_OWNED_LIST: &str = "/app/v3/api/mcp/servers/owned";
...
pub const SERVER_CONNECTORS_UPSERT: &str = "/app/v3/api/mcp/servers/{serverId}/connectors";
pub const SERVER_CONNECTORS_DELETE: &str =
